...
const Navbar = () => {
  const { cart, wishlist, toggleCart, theme, toggleTheme } = useContext(CartContext);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4">
        <div className="flex justify-between items-center">
          ...
          <Link to="/" className="flex items-center gap-2 group" onClick={() => setIsOpen(false)}>
            <span className="text-xl sm:text-2xl font-extrabold tracking-tight bg-gradient-to-r from-blue-600 to-blue-400 dark:from-blue-400 dark:to-blue-300 bg-clip-text text-transparent group-hover:opacity-90 transition-opacity">
              ShopNpay
            </span>
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <button
              onClick={toggleTheme}
              className="p-2 rounded-xl text-slate-500 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800/50 hover:text-slate-800 dark:hover:text-white transition-colors cursor-pointer"
